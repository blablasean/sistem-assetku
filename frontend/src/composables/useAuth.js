...
const userName = ref(localStorage.getItem('user_name') || 'Guest User')
...
export function useAuth() {
  function syncAuth() {
    userRole.value = localStorage.getItem('user_role') || 'external'
    userName.value = localStorage.getItem('user_name') || 'Guest User'
  }
